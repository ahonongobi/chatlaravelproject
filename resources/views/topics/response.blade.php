...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/inbox">Home</a><i class="fa fa-angle-right"></i>Inbox</li>
            </ol>
...
<div class="dropdown">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr class="table-row">
                            <td class="table-img">
                               <img src="{{ asset('images/in66.jpg')}}"  width="48" height="48" alt="">
                            </td>
                            <td class="table-text">
                            ...
                            <td>
                            	<span class="fam">{{$comment->commentable_type}}</span>
                            </td>
                            @endforeach
