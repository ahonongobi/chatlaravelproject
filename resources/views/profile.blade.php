             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h1><a href="/topics/message">Poster Message</a></h1>
							</div>
		...
		<div class="four-grids">
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Profile</h3>
								<img src="uploads/avatars/{{Auth::user()->avatar}}" width="48" height="48" alt="User" style="border-radius: 50%" />
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3>Changer Profile</h3>
								<form method="POST" enctype="multipart/form-data" action="/profile">
									{{@csrf_field()}}
									<input type="file" name="avatar">
									<input type="submit" name="" value="Chnger ">
